      ...
      <div className="flex items-center justify-between gap-4">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            ...
            className="pl-9 bg-white/5 border-white/10 text-foreground placeholder:text-muted-foreground h-9"
          />
        </div>
        <Button
          variant="outline"
          ...
          className="border-white/10 bg-white/5 text-foreground hover:bg-white/10 hover:text-foreground"
        >
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              ...
              >
                {headerGroup.headers.map((header) => (
                  <TableHead
                    key={header.id}
                    className="text-muted-foreground text-xs uppercase tracking-wider py-3 px-4"
              ...
              table.getRowModel().rows.map((row) => {
                ...
                return (
                  <TableRow
                    key={row.id}
                    className={`
                      border-white/10 transition-colors cursor-pointer hover:bg-white/5
                      ${
                        highlighted
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="bg-white/10 border border-white/20 text-foreground rounded px-2 py-1 text-xs"
          >
          ...
          <Button
            ...
            className="h-8 w-8 p-0 border-white/10 bg-white/5 text-muted-foreground disabled:opacity-30 hover:bg-white/10"
          >
